...
<ul>
    <li>
        ...
        Architecture Simulation as a Service has been awarded! Thanks to NSF and
        my collaborator Kate Isaacs!
    </li>
    <li>
        <span class="date">[Feb 2023]</span> Our NSF CRII Proposal Building Explainable
        Architecture with Simulation and Visualization Techniques has been awarded!
        Thank you NSF!
    </li>
    <li>
